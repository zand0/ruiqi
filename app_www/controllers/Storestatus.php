 ...
 * 门店状态设置
 */
class StorestatusController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'mzxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/storestatus/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('storestatus/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/storestatus/index');
    }
