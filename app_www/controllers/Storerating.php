 ...
 * 门店等级设置
 */
class StoreratingController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'mlxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/storerating/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('storerating/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/storerating/index');
    }
