 ...
 * 订单类型设置
 */
class OrdertypeController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'dlxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/ordertype/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('ordertype/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/ordertype/index');
    }
