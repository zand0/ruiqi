 ...
 * 门店类型设置
 */
class StoretypeController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            ...
            $this->success('创建成功', '/storetype/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('storetype/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/storetype/index');
    }
