 ...
 * 申请类型设置
 */
class ApplicationtypeController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'sqxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/applicationtype/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('applicationtype/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/applicationtype/index');
    }
