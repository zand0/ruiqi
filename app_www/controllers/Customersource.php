 ...
 * 客户来源设置
 */
class CustomersourceController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'lyxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/customersource/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('customersource/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/customersource/index');
    }
