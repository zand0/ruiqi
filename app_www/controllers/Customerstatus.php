 ...
 * 客户来源设置
 */
class CustomerstatusController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'ztxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/customerstatus/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('customerstatus/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/customerstatus/index');
    }
