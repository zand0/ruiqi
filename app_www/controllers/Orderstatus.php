 ...
 * 订单状态设置
 */
class OrderstatusController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'dzxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/orderstatus/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('orderstatus/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/orderstatus/index');
    }
