 ...
 * 审批状态设置
 */
class ApprovalstatusController extends \Com\Controller\Common {
    ...
    public function addAction() {
        ...
        if (IS_POST) {
            $app = new App();
            $data['typemanagersn'] = 'spxm' . $app->build_order_no();
            ...
            $this->success('创建成功', '/approvalstatus/index');
        }
    }
    ...
    public function editeAction() {
        ...
        $this->_view->display('approvalstatus/add.phtml');
    }
    ...
    public function delAction() {
        ...
        $this->success('ok', '/approvalstatus/index');
    }
