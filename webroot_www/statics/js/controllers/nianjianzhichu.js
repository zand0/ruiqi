                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        str = '<div class="pop_cont">\
                                    <div class="contRTitle2">添加年检支出 <span></span></div>\
                                    ...
                                    <div class="pl95 mb20"><a href="javascript:;" class="buleColor " id="addspending">+添加年检支出</a></div>\
                                    <div class="rqLine">\
                                        <div class="rqOption rqOption2 clearfix">\
