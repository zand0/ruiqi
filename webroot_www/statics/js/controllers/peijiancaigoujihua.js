        ...
        funcs.dialogFn = function () {
            $('.addCaigou').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (preview['product']) {
                            for (key in preview['product']) {
                                productHtml += "<option value='" + key + "'>" + preview['product'][key]['products_name'] + "</option>";
                            }
                        }
                        if (preview['supplier']) {
					...
					<div class="rqLine">\
						<div class="rqOption clearfix">\
							...
							<div class="selectBox fl">\
								<div class="mySelect">\
									<select name="" class="selectmenu" id="supplier_list" style="width:110px;">' + supplierHtml + '</select>\
								</div>\
							</div>\
						</div>\
					</div>\
					<div class="rqLine clearfix">\
						<div class="rqOption fl">\
							...
							<div class="selectBox fl">\
								<div class="mySelect">\
									<select name="" id="product_list" class="selectmenu"  style="width:110px;">' + productHtml + '</select>\
								</div>\
							</div>\
						</div>\
						<div class="rqOption fl">\
                ...
                $(dlg.node).find('#addplan').off('click').on('click', function () {
                    ...
                    var num = $("#num").val();
                    var price = $("#price").val();
                    var blist = product_id + '|' + supplier_id + '|' + num + '|' + price;
                    var fhtml = '<tr>\
                                                    <td>' + product_name + '</td>\
                                                    <td>' + num + '</td>\
                                                    <td>' + price + '</td>\
