...
define(['vendors/location/location'],function(){
    var ret = {};
    ret.init=function (json){  //json={province:'河南省',city:'南阳市',town:'镇平县',sheng:'loc_province2',shi:'loc_city2',qu:'loc_town2'}
        var json=json||{};     //多个区域调用需传sheng,shi,qu id值，一个不需要传
